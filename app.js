...
,
  ["human-resources-manager", "Human Resources Manager", "Human Resources", ["communicator", "structured", "empathetic", "strategic"], ["Policy leadership", "Employee relations", "Compliance", "Team coaching"]],
  ["personnel-manager", "Personnel Manager", "Human Resources", ["communicator", "structured", "empathetic", "strategic"], ["Policy leadership", "Employee relations", "Compliance", "Team coaching"]],
  ["labour-relations-manager", "Labour Relations Manager", "Human Resources", ["communicator", "structured", "empathetic", "strategic"], ["Policy leadership", "Employee relations", "Compliance", "Team coaching"]],
  ["compensation-manager", "Compensation Manager", "Human Resources", ["communicator", "structured", "empathetic", "strategic"], ["Policy leadership", "Employee relations", "Compliance", "Team coaching"]],
  ["benefits-manager", "Benefits Manager", "Human Resources", ["communicator", "structured", "empathetic", "strategic"], ["Policy leadership", "Employee relations", "Compliance", "Team coaching"]],
  ["recruiting-manager", "Recruiting Manager", "Human Resources", ["communicator", "structured", "empathetic", "strategic"], ["Policy leadership", "Employee relations", "Compliance", "Team coaching"]],
  ["training-and-development-manager", "Training and Development Manager", "Human Resources", ["communicator", "structured", "empathetic", "strategic"], ["Policy leadership", "Employee relations", "Compliance", "Team coaching"]],
  ["staffing-manager", "Staffing Manager", "Human Resources", ["communicator", "structured", "empathetic", "strategic"], ["Policy leadership", "Employee relations", "Compliance", "Team coaching"]],
  ["administrative-manager", "Administrative Manager", "Operations", ["structured", "communicator", "practical", "resilient"], ["Office operations", "Records management", "Team coordination", "Process improvement"]],
  ["administrative-services-manager", "Administrative Services Manager", "Operations", ["structured", "communicator", "practical", "resilient"], ["Office operations", "Records management", "Team coordination", "Process improvement"]],
  ["administrative-support-services-manager", "Administrative Support Services Manager", "Operations", ["structured", "communicator", "practical", "resilient"], ["Office operations", "Records management", "Team coordination", "Process improvement"]],
  ["records-administrator", "Records Administrator", "Operations", ["structured", "communicator", "practical", "resilient"], ["Office operations", "Records management", "Team coordination", "Process improvement"]],
  ["records-management-services-manager", "Records Management Services Manager", "Operations", ["structured", "communicator", "practical", "resilient"], ["Office operations", "Records management", "Team coordination", "Process improvement"]],
  ["operations-manager", "Operations Manager", "Operations", ["structured", "practical", "communicator", "analytical"], ["Operations planning", "Resource management", "Team leadership", "Performance tracking"]],
  ["operational-planning-director", "Operational Planning Director", "Operations", ["structured", "practical", "communicator", "analytical"], ["Operations planning", "Resource management", "Team leadership", "Performance tracking"]],
  ["planning-and-organizational-development-manager", "Planning and Organizational Development Manager", "Operations", ["structured", "practical", "communicator", "analytical"], ["Operations planning", "Resource management", "Team leadership", "Performance tracking"]],
  ["regional-administrative-manager", "Regional Administrative Manager", "Operations", ["structured", "communicator", "practical", "resilient"], ["Office operations", "Records management", "Team coordination", "Process improvement"]],
  ["security-manager", "Security Manager", "Public Safety", ["structured", "practical", "resilient", "communicator"], ["Security planning", "Risk assessment", "Incident response", "Team leadership"]],
  ["support-services-manager", "Support Services Manager", "Operations", ["structured", "communicator", "practical", "resilient"], ["Office operations", "Records management", "Team coordination", "Process improvement"]],
  ["managing-director", "Managing Director", "Operations", ["structured", "practical", "communicator", "analytical"], ["Operations planning", "Resource management", "Team leadership", "Performance tracking"]],
  ["business-manager", "Business Manager", "Operations", ["structured", "practical", "communicator", "analytical"], ["Operations planning", "Resource management", "Team leadership", "Performance tracking"]],
  ["finance-and-administration-director", "Finance and Administration Director", "Operations", ["structured", "practical", "communicator", "analytical"], ["Operations planning", "Resource management", "Team leadership", "Performance tracking"]],
  ["inventory-manager", "Inventory Manager", "Operations", ["structured", "practical", "communicator", "analytical"], ["Operations planning", "Resource management", "Team leadership", "Performance tracking"]],
  ["material-control-manager", "Material Control Manager", "Operations", ["structured", "practical", "communicator", "analytical"], ["Operations planning", "Resource management", "Team leadership", "Performance tracking"]],
  ["purchasing-manager", "Purchasing Manager", "Operations", ["analytical", "communicator", "structured", "practical"], ["Supplier negotiation", "Contract review", "Cost analysis", "Vendor management"]],
  ["procurement-manager", "Procurement Manager", "Operations", ["analytical", "communicator", "structured", "practical"], ["Supplier negotiation", "Contract review", "Cost analysis", "Vendor management"]],
  ["procurement-director", "Procurement Director", "Operations", ["analytical", "communicator", "structured", "practical"], ["Supplier negotiation", "Contract review", "Cost analysis", "Vendor management"]],
  ["supply-chain-logistics-manager", "Supply Chain Logistics Manager", "Operations", ["structured", "practical", "communicator", "analytical"], ["Operations planning", "Resource management", "Team leadership", "Performance tracking"]],
  ["material-manager", "Material Manager", "Operations", ["structured", "practical", "communicator", "analytical"], ["Operations planning", "Resource management", "Team leadership", "Performance tracking"]],
  ["equipment-manager", "Equipment Manager", "Operations", ["structured", "practical", "communicator", "analytical"], ["Operations planning", "Resource management", "Team leadership", "Performance tracking"]],
  ["contract-manager", "Contract Manager", "Operations", ["analytical", "communicator", "structured", "practical"], ["Supplier negotiation", "Contract review", "Cost analysis", "Vendor management"]],
  ["engineering-manager", "Engineering Manager", "Engineering", ["structured", "communicator", "analytical", "practical"], ["Engineering leadership", "Project oversight", "Quality systems", "Team coaching"]],
  ["engineering-department-manager", "Engineering Department Manager", "Engineering", ["structured", "communicator", "analytical", "practical"], ["Engineering leadership", "Project oversight", "Quality systems", "Team coaching"]],
  ["engineering-project-manager", "Engineering Project Manager", "Engineering", ["structured", "communicator", "analytical", "practical"], ["Engineering leadership", "Project oversight", "Quality systems", "Team coaching"]],
  ["engineering-research-and-development-director", "Engineering Research and Development Director", "Engineering", ["structured", "communicator", "analytical", "practical"], ["Engineering leadership", "Project oversight", "Quality systems", "Team coaching"]],
  ["engineering-quality-assurance-manager", "Engineering Quality Assurance Manager", "Engineering", ["structured", "communicator", "analytical", "practical"], ["Engineering leadership", "Project oversight", "Quality systems", "Team coaching"]],
  ["engineering-quality-control-manager", "Engineering Quality Control Manager", "Engineering", ["structured", "communicator", "analytical", "practical"], ["Engineering leadership", "Project oversight", "Quality systems", "Team coaching"]],
  ["accountant-controller", "Accountant-Controller", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["accounting-controller", "Accounting Controller", "Business", ["analytical", "communicator", "structured", "practical"], ["Problem solving", "Communication", "Planning", "Documentation"]],
  ["chartered-accountant", "Chartered Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["chartered-professional-accountant", "Chartered Professional Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["certified-general-accountant", "Certified General Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["certified-management-accountant", "Certified Management Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["chief-accountant", "Chief Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["cost-accountant", "Cost Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["financial-accountant", "Financial Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["financial-auditor", "Financial Auditor", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["financial-control-officer", "Financial Control Officer", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["general-accountant", "General Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["internal-auditor", "Internal Auditor", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["management-accountant", "Management Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["project-accountant", "Project Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["property-accountant", "Property Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["public-accountant", "Public Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["tax-accountant", "Tax Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["tax-adviser", "Tax Adviser", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["tax-analyst", "Tax Analyst", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["tax-auditor", "Tax Auditor", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["tax-consultant", "Tax Consultant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["tax-examiner", "Tax Examiner", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["tax-specialist", "Tax Specialist", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["reinsurance-analyst", "Reinsurance Analyst", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["budget-accountant", "Budget Accountant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["income-tax-consultant", "Income Tax Consultant", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["income-tax-specialist", "Income Tax Specialist", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["computer-audit-specialist", "Computer Audit Specialist", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["tax-expert", "Tax Expert", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["income-tax-adviser", "Income Tax Adviser", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["remote-sensing-geologist", "Remote Sensing Geologist", "Science", ["curious", "analytical", "hands-on", "practical"], ["Field mapping", "Data interpretation", "Geological analysis", "Report writing"]],
  ["sedimentary-geologist", "Sedimentary Geologist", "Science", ["curious", "analytical", "hands-on", "practical"], ["Field mapping", "Data interpretation", "Geological analysis", "Report writing"]],
  ["sedimentologist", "Sedimentologist", "Science", ["curious", "analytical", "hands-on", "practical"], ["Field mapping", "Data interpretation", "Geological analysis", "Report writing"]],
  ["seismologist", "Seismologist", "Science", ["curious", "analytical", "hands-on", "practical"], ["Field mapping", "Data interpretation", "Geological analysis", "Report writing"]],
  ["stratigrapher", "Stratigrapher", "Science", ["curious", "analytical", "hands-on", "practical"], ["Field mapping", "Data interpretation", "Geological analysis", "Report writing"]],
  ["structural-geologist", "Structural Geologist", "Science", ["curious", "analytical", "hands-on", "practical"], ["Field mapping", "Data interpretation", "Geological analysis", "Report writing"]],
  ["volcanologist", "Volcanologist", "Science", ["curious", "analytical", "hands-on", "practical"], ["Field mapping", "Data interpretation", "Geological analysis", "Report writing"]],
  ["quaternary-specialist", "Quaternary Specialist", "Science", ["curious", "analytical", "hands-on", "practical"], ["Field mapping", "Data interpretation", "Geological analysis", "Report writing"]],
  ["wellsite-coordinator-geology", "Wellsite Coordinator (Geology)", "Science", ["curious", "analytical", "hands-on", "practical"], ["Field mapping", "Data interpretation", "Geological analysis", "Report writing"]],
  ["geological-engineer", "Geological Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Site analysis", "Engineering design", "Field investigation", "Technical reporting"]],
  ["geophysical-engineer", "Geophysical Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Site analysis", "Engineering design", "Field investigation", "Technical reporting"]],
  ["geotechnical-engineer", "Geotechnical Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Site analysis", "Engineering design", "Field investigation", "Technical reporting"]],
  ["hydrogeological-engineer", "Hydrogeological Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Site analysis", "Engineering design", "Field investigation", "Technical reporting"]],
  ["hydrogeology-engineer", "Hydrogeology Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Site analysis", "Engineering design", "Field investigation", "Technical reporting"]],
  ["rock-sciences-engineer", "Rock Sciences Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Site analysis", "Engineering design", "Field investigation", "Technical reporting"]],
  ["petrography-engineer", "Petrography Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Site analysis", "Engineering design", "Field investigation", "Technical reporting"]],
  ["school-principal", "School Principal", "Education", ["communicator", "structured", "empathetic", "strategic"], ["School leadership", "Staff development", "Student outcomes", "Community engagement"]],
  ["secondary-school-principal", "Secondary School Principal", "Education", ["communicator", "structured", "empathetic", "strategic"], ["School leadership", "Staff development", "Student outcomes", "Community engagement"]],
  ["technical-high-school-principal", "Technical High School Principal", "Education", ["communicator", "structured", "empathetic", "strategic"], ["School leadership", "Staff development", "Student outcomes", "Community engagement"]],
  ["vocational-high-school-principal", "Vocational High School Principal", "Education", ["communicator", "structured", "empathetic", "strategic"], ["School leadership", "Staff development", "Student outcomes", "Community engagement"]],
  ["superintendent-of-schools", "Superintendent of Schools", "Education", ["communicator", "structured", "empathetic", "strategic"], ["School leadership", "Staff development", "Student outcomes", "Community engagement"]],
  ["superintendent-of-secondary-schools", "Superintendent of Secondary Schools", "Education", ["communicator", "structured", "empathetic", "strategic"], ["School leadership", "Staff development", "Student outcomes", "Community engagement"]],
  ["superintendent-of-special-education", "Superintendent of Special Education", "Education", ["communicator", "structured", "empathetic", "strategic"], ["School leadership", "Staff development", "Student outcomes", "Community engagement"]],
  ["superintendent-of-student-services", "Superintendent of Student Services", "Education", ["communicator", "structured", "empathetic", "strategic"], ["School leadership", "Staff development", "Student outcomes", "Community engagement"]],
  ["arbitrager", "Arbitrager", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["broker", "Broker", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["bond-broker", "Bond Broker", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["bond-dealer", "Bond Dealer", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["bond-trader", "Bond Trader", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["commodity-broker", "Commodity Broker", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["commodity-trader", "Commodity Trader", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["equity-trader", "Equity Trader", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["financial-broker", "Financial Broker", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["foreign-exchange-dealer", "Foreign Exchange Dealer", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["foreign-exchange-trader", "Foreign Exchange Trader", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["futures-trader", "Futures Trader", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["investment-broker", "Investment Broker", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["investment-dealer", "Investment Dealer", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["investment-representative", "Investment Representative", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["mutual-fund-broker", "Mutual Fund Broker", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["options-trader", "Options Trader", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["securities-agent", "Securities Agent", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["securities-representative", "Securities Representative", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["securities-trader", "Securities Trader", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["stockbroker", "Stockbroker", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["stocks-and-bonds-trader", "Stocks and Bonds Trader", "Finance", ["analytical", "resilient", "communicator", "structured"], ["Market analysis", "Client advising", "Risk management", "Trade execution"]],
  ["mining-engineer", "Mining Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Mine planning", "Safety systems", "Production optimization", "Technical design"]],
  ["consulting-mining-engineer", "Consulting Mining Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Mine planning", "Safety systems", "Production optimization", "Technical design"]],
  ["mine-design-engineer", "Mine Design Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Mine planning", "Safety systems", "Production optimization", "Technical design"]],
  ["mine-development-engineer", "Mine Development Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Mine planning", "Safety systems", "Production optimization", "Technical design"]],
  ["mine-planning-engineer", "Mine Planning Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Mine planning", "Safety systems", "Production optimization", "Technical design"]],
  ["mine-production-engineer", "Mine Production Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Mine planning", "Safety systems", "Production optimization", "Technical design"]],
  ["mine-safety-engineer", "Mine Safety Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Mine planning", "Safety systems", "Production optimization", "Technical design"]],
  ["mine-ventilation-engineer", "Mine Ventilation Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Mine planning", "Safety systems", "Production optimization", "Technical design"]],
  ["mineral-engineer", "Mineral Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Mine planning", "Safety systems", "Production optimization", "Technical design"]],
  ["mineral-dressing-engineer", "Mineral Dressing Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Mine planning", "Safety systems", "Production optimization", "Technical design"]],
  ["mines-exploration-engineer", "Mines Exploration Engineer", "Engineering", ["analytical", "hands-on", "structured", "practical"], ["Mine planning", "Safety systems", "Production optimization", "Technical design"]],
  ["consulting-architect", "Consulting Architect", "Design", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["project-architect", "Project Architect", "Design", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["design-architect", "Design Architect", "Design", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["landscape-architect", "Landscape Architect", "Design", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["community-planner", "Community Planner", "Government", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["regional-planner", "Regional Planner", "Government", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["city-planner", "City Planner", "Government", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["environmental-planner", "Environmental Planner", "Government", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["mathematical-statistician", "Mathematical Statistician", "Science", ["analytical", "structured", "curious", "independent"], ["Statistical modeling", "Data analysis", "Study design", "Communication"]],
  ["applied-statistician", "Applied Statistician", "Science", ["analytical", "structured", "curious", "independent"], ["Statistical modeling", "Data analysis", "Study design", "Communication"]],
  ["biostatistician", "Biostatistician", "Science", ["analytical", "structured", "curious", "independent"], ["Statistical modeling", "Data analysis", "Study design", "Communication"]],
  ["statistical-analyst", "Statistical Analyst", "Science", ["analytical", "structured", "curious", "independent"], ["Statistical modeling", "Data analysis", "Study design", "Communication"]],
  ["quantitative-analyst", "Quantitative Analyst", "Science", ["analytical", "structured", "curious", "independent"], ["Statistical modeling", "Data analysis", "Study design", "Communication"]],
  ["demographer", "Demographer", "Science", ["analytical", "structured", "curious", "independent"], ["Statistical modeling", "Data analysis", "Study design", "Communication"]],
  ["information-systems-manager", "Information Systems Manager", "Technology", ["structured", "communicator", "analytical", "strategic"], ["Technology leadership", "Team coordination", "Budget planning", "Security oversight"]],
  ["computer-systems-manager", "Computer Systems Manager", "Technology", ["structured", "communicator", "analytical", "strategic"], ["Technology leadership", "Team coordination", "Budget planning", "Security oversight"]],
  ["it-manager", "IT Manager", "Technology", ["structured", "communicator", "analytical", "strategic"], ["Technology leadership", "Team coordination", "Budget planning", "Security oversight"]],
  ["information-technology-manager", "Information Technology Manager", "Technology", ["structured", "communicator", "analytical", "strategic"], ["Technology leadership", "Team coordination", "Budget planning", "Security oversight"]],
  ["systems-development-manager", "Systems Development Manager", "Technology", ["structured", "communicator", "analytical", "strategic"], ["Technology leadership", "Team coordination", "Budget planning", "Security oversight"]],
  ["information-services-director", "Information Services Director", "Technology", ["structured", "communicator", "analytical", "strategic"], ["Technology leadership", "Team coordination", "Budget planning", "Security oversight"]],
  ["software-development-manager", "Software Development Manager", "Technology", ["structured", "communicator", "analytical", "strategic"], ["Technology leadership", "Team coordination", "Budget planning", "Security oversight"]],
  ["database-manager", "Database Manager", "Technology", ["structured", "communicator", "analytical", "strategic"], ["Technology leadership", "Team coordination", "Budget planning", "Security oversight"]],
  ["network-manager", "Network Manager", "Technology", ["structured", "communicator", "analytical", "strategic"], ["Technology leadership", "Team coordination", "Budget planning", "Security oversight"]],
  ["information-security-manager", "Information Security Manager", "Technology", ["structured", "communicator", "analytical", "strategic"], ["Technology leadership", "Team coordination", "Budget planning", "Security oversight"]],
  ["technology-project-manager", "Technology Project Manager", "Technology", ["structured", "communicator", "analytical", "strategic"], ["Technology leadership", "Team coordination", "Budget planning", "Security oversight"]],
  ["physicist", "Physicist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["biochemist", "Biochemist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["microbiologist", "Microbiologist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["molecular-biologist", "Molecular Biologist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["biologist", "Biologist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["research-scientist", "Research Scientist", "Science", ["curious", "analytical", "structured", "independent"], ["Research design", "Data collection", "Analysis", "Scientific communication"]],
  ["research-associate", "Research Associate", "Science", ["curious", "analytical", "structured", "independent"], ["Research design", "Data collection", "Analysis", "Scientific communication"]],
  ["laboratory-director", "Laboratory Director", "Science", ["curious", "analytical", "structured", "independent"], ["Research design", "Data collection", "Analysis", "Scientific communication"]],
  ["organizational-consultant", "Organizational Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["business-consultant", "Business Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["strategic-planning-consultant", "Strategic Planning Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["human-resources-consultant", "Human Resources Consultant", "Human Resources", ["communicator", "structured", "empathetic", "strategic"], ["Policy leadership", "Employee relations", "Compliance", "Team coaching"]],
  ["training-consultant", "Training Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["operations-consultant", "Operations Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["process-improvement-consultant", "Process Improvement Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["general-dentist", "General Dentist", "Healthcare", ["hands-on", "empathetic", "structured", "analytical"], ["Clinical diagnosis", "Patient care", "Treatment planning", "Oral health"]],
  ["family-dentist", "Family Dentist", "Healthcare", ["hands-on", "empathetic", "structured", "analytical"], ["Clinical diagnosis", "Patient care", "Treatment planning", "Oral health"]],
  ["dental-surgeon", "Dental Surgeon", "Healthcare", ["hands-on", "empathetic", "structured", "analytical"], ["Clinical diagnosis", "Patient care", "Treatment planning", "Oral health"]],
  ["orthodontist", "Orthodontist", "Healthcare", ["hands-on", "empathetic", "structured", "analytical"], ["Clinical diagnosis", "Patient care", "Treatment planning", "Oral health"]],
  ["periodontist", "Periodontist", "Healthcare", ["hands-on", "empathetic", "structured", "analytical"], ["Clinical diagnosis", "Patient care", "Treatment planning", "Oral health"]],
  ["endodontist", "Endodontist", "Healthcare", ["hands-on", "empathetic", "structured", "analytical"], ["Clinical diagnosis", "Patient care", "Treatment planning", "Oral health"]],
  ["prosthodontist", "Prosthodontist", "Healthcare", ["hands-on", "empathetic", "structured", "analytical"], ["Clinical diagnosis", "Patient care", "Treatment planning", "Oral health"]],
  ["pediatric-dentist", "Pediatric Dentist", "Healthcare", ["hands-on", "empathetic", "structured", "analytical"], ["Clinical diagnosis", "Patient care", "Treatment planning", "Oral health"]],
  ["oral-pathologist", "Oral Pathologist", "Healthcare", ["hands-on", "empathetic", "structured", "analytical"], ["Clinical diagnosis", "Patient care", "Treatment planning", "Oral health"]],
  ["oral-radiologist", "Oral Radiologist", "Healthcare", ["hands-on", "empathetic", "structured", "analytical"], ["Clinical diagnosis", "Patient care", "Treatment planning", "Oral health"]],
  ["public-health-dentist", "Public Health Dentist", "Healthcare", ["hands-on", "empathetic", "structured", "analytical"], ["Clinical diagnosis", "Patient care", "Treatment planning", "Oral health"]],
  ["physician", "Physician", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["family-physician", "Family Physician", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["general-practitioner", "General Practitioner", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["medical-specialist", "Medical Specialist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["surgeon", "Surgeon", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["anesthesiologist", "Anesthesiologist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["cardiologist", "Cardiologist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["dermatologist", "Dermatologist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["emergency-physician", "Emergency Physician", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["gastroenterologist", "Gastroenterologist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["neurologist", "Neurologist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["obstetrician-gynecologist", "Obstetrician-Gynecologist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["oncologist", "Oncologist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["ophthalmologist", "Ophthalmologist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["orthopedic-surgeon", "Orthopedic Surgeon", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["pediatrician", "Pediatrician", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["psychiatrist", "Psychiatrist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["radiologist", "Radiologist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["urologist", "Urologist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["registered-nurse", "Registered Nurse", "Healthcare", ["empathetic", "hands-on", "structured", "resilient"], ["Patient assessment", "Clinical care", "Documentation", "Team collaboration"]],
  ["nurse-practitioner", "Nurse Practitioner", "Healthcare", ["empathetic", "hands-on", "structured", "resilient"], ["Patient assessment", "Clinical care", "Documentation", "Team collaboration"]],
  ["clinical-nurse-specialist", "Clinical Nurse Specialist", "Healthcare", ["empathetic", "hands-on", "structured", "resilient"], ["Patient assessment", "Clinical care", "Documentation", "Team collaboration"]],
  ["community-health-nurse", "Community Health Nurse", "Healthcare", ["empathetic", "hands-on", "structured", "resilient"], ["Patient assessment", "Clinical care", "Documentation", "Team collaboration"]],
  ["occupational-health-nurse", "Occupational Health Nurse", "Healthcare", ["empathetic", "hands-on", "structured", "resilient"], ["Patient assessment", "Clinical care", "Documentation", "Team collaboration"]],
  ["public-health-nurse", "Public Health Nurse", "Healthcare", ["empathetic", "hands-on", "structured", "resilient"], ["Patient assessment", "Clinical care", "Documentation", "Team collaboration"]],
  ["psychiatric-nurse", "Psychiatric Nurse", "Healthcare", ["empathetic", "hands-on", "structured", "resilient"], ["Patient assessment", "Clinical care", "Documentation", "Team collaboration"]],
  ["physiotherapist", "Physiotherapist", "Healthcare", ["empathetic", "hands-on", "structured", "resilient"], ["Patient assessment", "Clinical care", "Documentation", "Team collaboration"]],
  ["audiologist", "Audiologist", "Healthcare", ["empathetic", "hands-on", "structured", "resilient"], ["Patient assessment", "Clinical care", "Documentation", "Team collaboration"]],
  ["kinesiologist", "Kinesiologist", "Healthcare", ["empathetic", "hands-on", "structured", "resilient"], ["Patient assessment", "Clinical care", "Documentation", "Team collaboration"]],
  ["clinical-psychologist", "Clinical Psychologist", "Healthcare", ["empathetic", "analytical", "communicator", "structured"], ["Assessment", "Counseling", "Treatment planning", "Clinical documentation"]],
  ["counselling-psychologist", "Counselling Psychologist", "Healthcare", ["empathetic", "analytical", "communicator", "structured"], ["Assessment", "Counseling", "Treatment planning", "Clinical documentation"]],
  ["neuropsychologist", "Neuropsychologist", "Healthcare", ["empathetic", "analytical", "communicator", "structured"], ["Assessment", "Counseling", "Treatment planning", "Clinical documentation"]],
  ["school-psychologist", "School Psychologist", "Healthcare", ["empathetic", "analytical", "communicator", "structured"], ["Assessment", "Counseling", "Treatment planning", "Clinical documentation"]],
  ["psychotherapist", "Psychotherapist", "Healthcare", ["empathetic", "analytical", "communicator", "structured"], ["Assessment", "Counseling", "Treatment planning", "Clinical documentation"]],
  ["clinical-pharmacist", "Clinical Pharmacist", "Healthcare", ["analytical", "empathetic", "structured", "communicator"], ["Clinical advising", "Medication knowledge", "Patient counseling", "Safety checks"]],
  ["hospital-pharmacist", "Hospital Pharmacist", "Healthcare", ["analytical", "empathetic", "structured", "communicator"], ["Clinical advising", "Medication knowledge", "Patient counseling", "Safety checks"]],
  ["research-pharmacist", "Research Pharmacist", "Healthcare", ["analytical", "empathetic", "structured", "communicator"], ["Clinical advising", "Medication knowledge", "Patient counseling", "Safety checks"]],
  ["optometrist", "Optometrist", "Healthcare", ["analytical", "empathetic", "structured", "communicator"], ["Clinical advising", "Medication knowledge", "Patient counseling", "Safety checks"]],
  ["optometric-consultant", "Optometric Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["chiropractor", "Chiropractor", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["naturopathic-doctor", "Naturopathic Doctor", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["podiatrist", "Podiatrist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["chiropodist", "Chiropodist", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["nutritionist", "Nutritionist", "Healthcare", ["empathetic", "analytical", "communicator", "practical"], ["Nutrition assessment", "Meal planning", "Health education", "Client counseling"]],
  ["midwife", "Midwife", "Healthcare", ["empathetic", "analytical", "structured", "resilient"], ["Clinical assessment", "Diagnosis", "Treatment planning", "Patient communication"]],
  ["medical-researcher", "Medical Researcher", "Science", ["curious", "analytical", "structured", "independent"], ["Research design", "Data collection", "Analysis", "Scientific communication"]],
  ["clinical-research-associate", "Clinical Research Associate", "Science", ["curious", "analytical", "structured", "independent"], ["Research design", "Data collection", "Analysis", "Scientific communication"]],
  ["biomedical-scientist", "Biomedical Scientist", "Science", ["curious", "analytical", "structured", "independent"], ["Research design", "Data collection", "Analysis", "Scientific communication"]],
  ["pathologist-assistant", "Pathologist Assistant", "Healthcare", ["empathetic", "hands-on", "structured", "resilient"], ["Patient assessment", "Clinical care", "Documentation", "Team collaboration"]],
  ["clinical-social-worker", "Clinical Social Worker", "Human Services", ["empathetic", "communicator", "structured", "resilient"], ["Client support", "Resource navigation", "Counseling", "Case documentation"]],
  ["medical-social-worker", "Medical Social Worker", "Human Services", ["empathetic", "communicator", "structured", "resilient"], ["Client support", "Resource navigation", "Counseling", "Case documentation"]],
  ["school-social-worker", "School Social Worker", "Human Services", ["empathetic", "communicator", "structured", "resilient"], ["Client support", "Resource navigation", "Counseling", "Case documentation"]],
  ["career-counsellor", "Career Counsellor", "Human Services", ["empathetic", "communicator", "structured", "resilient"], ["Client support", "Resource navigation", "Counseling", "Case documentation"]],
  ["employment-counsellor", "Employment Counsellor", "Human Services", ["empathetic", "communicator", "structured", "resilient"], ["Client support", "Resource navigation", "Counseling", "Case documentation"]],
  ["guidance-counsellor", "Guidance Counsellor", "Human Services", ["empathetic", "communicator", "structured", "resilient"], ["Client support", "Resource navigation", "Counseling", "Case documentation"]],
  ["rehabilitation-counsellor", "Rehabilitation Counsellor", "Human Services", ["empathetic", "communicator", "structured", "resilient"], ["Client support", "Resource navigation", "Counseling", "Case documentation"]],
  ["vocational-counsellor", "Vocational Counsellor", "Human Services", ["empathetic", "communicator", "structured", "resilient"], ["Client support", "Resource navigation", "Counseling", "Case documentation"]],
  ["sociologist", "Sociologist", "Science", ["curious", "analytical", "communicator", "structured"], ["Research methods", "Data analysis", "Fieldwork", "Academic writing"]],
  ["anthropologist", "Anthropologist", "Science", ["curious", "analytical", "communicator", "structured"], ["Research methods", "Data analysis", "Fieldwork", "Academic writing"]],
  ["archaeologist", "Archaeologist", "Science", ["curious", "analytical", "communicator", "structured"], ["Research methods", "Data analysis", "Fieldwork", "Academic writing"]],
  ["political-scientist", "Political Scientist", "Science", ["curious", "analytical", "communicator", "structured"], ["Research methods", "Data analysis", "Fieldwork", "Academic writing"]],
  ["criminologist", "Criminologist", "Science", ["curious", "analytical", "communicator", "structured"], ["Research methods", "Data analysis", "Fieldwork", "Academic writing"]],
  ["barrister", "Barrister", "Legal", ["analytical", "communicator", "structured", "resilient"], ["Legal research", "Case analysis", "Advocacy", "Client advising"]],
  ["solicitor", "Solicitor", "Legal", ["analytical", "communicator", "structured", "resilient"], ["Legal research", "Case analysis", "Advocacy", "Client advising"]],
  ["notary", "Notary", "Legal", ["analytical", "communicator", "structured", "resilient"], ["Legal research", "Case analysis", "Advocacy", "Client advising"]],
  ["legal-counsel", "Legal Counsel", "Legal", ["analytical", "communicator", "structured", "resilient"], ["Legal research", "Case analysis", "Advocacy", "Client advising"]],
  ["corporate-counsel", "Corporate Counsel", "Legal", ["analytical", "communicator", "structured", "resilient"], ["Legal research", "Case analysis", "Advocacy", "Client advising"]],
  ["crown-prosecutor", "Crown Prosecutor", "Legal", ["analytical", "communicator", "structured", "resilient"], ["Legal research", "Case analysis", "Advocacy", "Client advising"]],
  ["administrative-law-specialist", "Administrative Law Specialist", "Operations", ["structured", "communicator", "practical", "resilient"], ["Office operations", "Records management", "Team coordination", "Process improvement"]],
  ["labour-lawyer", "Labour Lawyer", "Business", ["analytical", "communicator", "structured", "practical"], ["Problem solving", "Communication", "Planning", "Documentation"]],
  ["tax-lawyer", "Tax Lawyer", "Finance", ["analytical", "structured", "practical", "independent"], ["Financial records", "Regulatory compliance", "Analysis", "Reporting"]],
  ["intellectual-property-lawyer", "Intellectual Property Lawyer", "Legal", ["analytical", "communicator", "structured", "resilient"], ["Legal research", "Case analysis", "Advocacy", "Client advising"]],
  ["arbitrator", "Arbitrator", "Legal", ["analytical", "communicator", "structured", "resilient"], ["Legal research", "Case analysis", "Advocacy", "Client advising"]],
  ["professor", "Professor", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["associate-professor", "Associate Professor", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["assistant-professor", "Assistant Professor", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["lecturer", "Lecturer", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["university-instructor", "University Instructor", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["college-instructor", "College Instructor", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["secondary-school-teacher", "Secondary School Teacher", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["elementary-school-teacher", "Elementary School Teacher", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["educational-consultant", "Educational Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["guidance-teacher", "Guidance Teacher", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["school-administrator", "School Administrator", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["academic-dean", "Academic Dean", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["faculty-dean", "Faculty Dean", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["registrar", "Registrar", "Education", ["communicator", "empathetic", "structured", "creative"], ["Instruction", "Curriculum design", "Student support", "Assessment"]],
  ["education-researcher", "Education Researcher", "Science", ["curious", "analytical", "structured", "independent"], ["Research design", "Data collection", "Analysis", "Scientific communication"]],
  ["research-coordinator", "Research Coordinator", "Science", ["curious", "analytical", "structured", "independent"], ["Research design", "Data collection", "Analysis", "Scientific communication"]],
  ["principal-investigator", "Principal Investigator", "Education", ["communicator", "structured", "empathetic", "strategic"], ["School leadership", "Staff development", "Student outcomes", "Community engagement"]],
  ["scientific-director", "Scientific Director", "Science", ["curious", "analytical", "structured", "independent"], ["Research design", "Data collection", "Analysis", "Scientific communication"]],
  ["research-manager", "Research Manager", "Science", ["curious", "analytical", "structured", "independent"], ["Research design", "Data collection", "Analysis", "Scientific communication"]],
  ["research-consultant", "Research Consultant", "Science", ["curious", "analytical", "structured", "independent"], ["Research design", "Data collection", "Analysis", "Scientific communication"]],
  ["software-engineer", "Software Engineer", "Technology", ["builder", "analytical", "structured", "independent"], ["Software design", "Problem solving", "System architecture", "Technical documentation"]],
  ["application-developer", "Application Developer", "Technology", ["builder", "analytical", "structured", "independent"], ["Software design", "Problem solving", "System architecture", "Technical documentation"]],
  ["business-systems-analyst", "Business Systems Analyst", "Technology", ["builder", "analytical", "structured", "independent"], ["Software design", "Problem solving", "System architecture", "Technical documentation"]],
  ["computer-programmer", "Computer Programmer", "Technology", ["builder", "analytical", "structured", "independent"], ["Software design", "Problem solving", "System architecture", "Technical documentation"]],
  ["computer-scientist", "Computer Scientist", "Technology", ["builder", "analytical", "structured", "independent"], ["Software design", "Problem solving", "System architecture", "Technical documentation"]],
  ["data-architect", "Data Architect", "Design", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["solutions-architect", "Solutions Architect", "Design", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["enterprise-architect", "Enterprise Architect", "Design", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["systems-architect", "Systems Architect", "Design", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["network-architect", "Network Architect", "Design", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["cloud-architect", "Cloud Architect", "Design", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["cybersecurity-specialist", "Cybersecurity Specialist", "Technology", ["builder", "analytical", "structured", "independent"], ["Software design", "Problem solving", "System architecture", "Technical documentation"]],
  ["information-security-analyst", "Information Security Analyst", "Technology", ["builder", "analytical", "structured", "independent"], ["Software design", "Problem solving", "System architecture", "Technical documentation"]],
  ["security-architect", "Security Architect", "Design", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["artificial-intelligence-specialist", "Artificial Intelligence Specialist", "Technology", ["builder", "analytical", "structured", "independent"], ["Software design", "Problem solving", "System architecture", "Technical documentation"]],
  ["analytics-consultant", "Analytics Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["visual-designer", "Visual Designer", "Design", ["creative", "visual", "empathetic", "analytical"], ["Visual design", "Prototyping", "User research", "Design systems"]],
  ["interaction-designer", "Interaction Designer", "Design", ["creative", "visual", "empathetic", "analytical"], ["Visual design", "Prototyping", "User research", "Design systems"]],
  ["exhibition-designer", "Exhibition Designer", "Design", ["creative", "visual", "empathetic", "analytical"], ["Visual design", "Prototyping", "User research", "Design systems"]],
  ["design-consultant", "Design Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["creative-director", "Creative Director", "Design", ["creative", "visual", "empathetic", "analytical"], ["Visual design", "Prototyping", "User research", "Design systems"]],
  ["communications-advisor", "Communications Advisor", "Marketing", ["communicator", "creative", "analytical", "structured"], ["Messaging strategy", "Audience research", "Campaign planning", "Content creation"]],
  ["communications-consultant", "Communications Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["public-relations-consultant", "Public Relations Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["media-relations-specialist", "Media Relations Specialist", "Marketing", ["communicator", "creative", "analytical", "structured"], ["Messaging strategy", "Audience research", "Campaign planning", "Content creation"]],
  ["corporate-communications-manager", "Corporate Communications Manager", "Marketing", ["communicator", "creative", "analytical", "structured"], ["Messaging strategy", "Audience research", "Campaign planning", "Content creation"]],
  ["communications-director", "Communications Director", "Marketing", ["communicator", "creative", "analytical", "structured"], ["Messaging strategy", "Audience research", "Campaign planning", "Content creation"]],
  ["writer", "Writer", "Language & Communication", ["communicator", "creative", "structured", "curious"], ["Writing", "Editing", "Research", "Audience awareness"]],
  ["author", "Author", "Language & Communication", ["communicator", "creative", "structured", "curious"], ["Writing", "Editing", "Research", "Audience awareness"]],
  ["copy-editor", "Copy Editor", "Language & Communication", ["communicator", "creative", "structured", "curious"], ["Writing", "Editing", "Research", "Audience awareness"]],
  ["reporter", "Reporter", "Language & Communication", ["communicator", "creative", "structured", "curious"], ["Writing", "Editing", "Research", "Audience awareness"]],
  ["columnist", "Columnist", "Language & Communication", ["communicator", "creative", "structured", "curious"], ["Writing", "Editing", "Research", "Audience awareness"]],
  ["translator", "Translator", "Language & Communication", ["communicator", "creative", "structured", "curious"], ["Writing", "Editing", "Research", "Audience awareness"]],
  ["interpreter", "Interpreter", "Language & Communication", ["communicator", "creative", "structured", "curious"], ["Writing", "Editing", "Research", "Audience awareness"]],
  ["consumer-research-analyst", "Consumer Research Analyst", "Marketing", ["communicator", "creative", "analytical", "structured"], ["Messaging strategy", "Audience research", "Campaign planning", "Content creation"]],
  ["marketing-analyst", "Marketing Analyst", "Marketing", ["communicator", "creative", "analytical", "structured"], ["Messaging strategy", "Audience research", "Campaign planning", "Content creation"]],
  ["brand-strategist", "Brand Strategist", "Marketing", ["communicator", "creative", "analytical", "structured"], ["Messaging strategy", "Audience research", "Campaign planning", "Content creation"]],
  ["marketing-consultant", "Marketing Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["digital-marketing-consultant", "Digital Marketing Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["marketing-manager", "Marketing Manager", "Marketing", ["communicator", "creative", "analytical", "structured"], ["Messaging strategy", "Audience research", "Campaign planning", "Content creation"]],
  ["musician", "Musician", "Arts", ["creative", "communicator", "resilient", "hands-on"], ["Performance", "Creative direction", "Collaboration", "Artistic technique"]],
  ["composer", "Composer", "Arts", ["creative", "communicator", "resilient", "hands-on"], ["Performance", "Creative direction", "Collaboration", "Artistic technique"]],
  ["conductor", "Conductor", "Arts", ["creative", "communicator", "resilient", "hands-on"], ["Performance", "Creative direction", "Collaboration", "Artistic technique"]],
  ["actor", "Actor", "Arts", ["creative", "communicator", "resilient", "hands-on"], ["Performance", "Creative direction", "Collaboration", "Artistic technique"]],
  ["performer", "Performer", "Arts", ["creative", "communicator", "resilient", "hands-on"], ["Performance", "Creative direction", "Collaboration", "Artistic technique"]],
  ["dancer", "Dancer", "Arts", ["creative", "communicator", "resilient", "hands-on"], ["Performance", "Creative direction", "Collaboration", "Artistic technique"]],
  ["choreographer", "Choreographer", "Arts", ["creative", "communicator", "resilient", "hands-on"], ["Performance", "Creative direction", "Collaboration", "Artistic technique"]],
  ["film-director", "Film Director", "Arts", ["creative", "communicator", "resilient", "hands-on"], ["Performance", "Creative direction", "Collaboration", "Artistic technique"]],
  ["producer", "Producer", "Arts", ["creative", "communicator", "resilient", "hands-on"], ["Performance", "Creative direction", "Collaboration", "Artistic technique"]],
  ["screenwriter", "Screenwriter", "Language & Communication", ["communicator", "creative", "structured", "curious"], ["Writing", "Editing", "Research", "Audience awareness"]],
  ["museum-conservator", "Museum Conservator", "Arts", ["curious", "structured", "creative", "hands-on"], ["Collections care", "Research", "Preservation", "Interpretation"]],
  ["art-historian", "Art Historian", "Arts", ["curious", "structured", "creative", "hands-on"], ["Collections care", "Research", "Preservation", "Interpretation"]],
  ["urban-designer", "Urban Designer", "Government", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["planning-consultant", "Planning Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["heritage-planner", "Heritage Planner", "Government", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["land-use-planner", "Land Use Planner", "Government", ["creative", "visual", "structured", "communicator"], ["Design development", "Site analysis", "Client consultation", "Technical drawings"]],
  ["structural-engineer", "Structural Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["municipal-engineer", "Municipal Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["water-resources-engineer", "Water Resources Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["transportation-engineer", "Transportation Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["highway-engineer", "Highway Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["construction-engineer", "Construction Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["environmental-engineer", "Environmental Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["project-engineer", "Project Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["design-engineer", "Design Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["consulting-engineer", "Consulting Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["industrial-engineer", "Industrial Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["manufacturing-systems-engineer", "Manufacturing Systems Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["reliability-engineer", "Reliability Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["product-development-engineer", "Product Development Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["systems-engineer", "Systems Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["automation-engineer", "Automation Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["human-factors-engineer", "Human Factors Engineer", "Arts", ["creative", "communicator", "resilient", "hands-on"], ["Performance", "Creative direction", "Collaboration", "Artistic technique"]],
  ["electrical-engineer", "Electrical Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["electronics-engineer", "Electronics Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["computer-engineer", "Computer Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["communications-engineer", "Communications Engineer", "Marketing", ["communicator", "creative", "analytical", "structured"], ["Messaging strategy", "Audience research", "Campaign planning", "Content creation"]],
  ["telecommunications-engineer", "Telecommunications Engineer", "Marketing", ["communicator", "creative", "analytical", "structured"], ["Messaging strategy", "Audience research", "Campaign planning", "Content creation"]],
  ["control-systems-engineer", "Control Systems Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["instrumentation-engineer", "Instrumentation Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["embedded-systems-engineer", "Embedded Systems Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["signal-processing-engineer", "Signal Processing Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["aeronautical-engineer", "Aeronautical Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["astronautical-engineer", "Astronautical Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["flight-systems-engineer", "Flight Systems Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["avionics-engineer", "Avionics Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["space-systems-engineer", "Space Systems Engineer", "Engineering", ["analytical", "builder", "structured", "practical"], ["Engineering design", "Technical analysis", "Project documentation", "Safety standards"]],
  ["theoretical-physicist", "Theoretical Physicist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["applied-physicist", "Applied Physicist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["medical-physicist", "Medical Physicist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["analytical-chemist", "Analytical Chemist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["organic-chemist", "Organic Chemist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["physical-chemist", "Physical Chemist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["environmental-chemist", "Environmental Chemist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["geneticist", "Geneticist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["cell-biologist", "Cell Biologist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["immunologist", "Immunologist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["zoologist", "Zoologist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["ecologist", "Ecologist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["botanist", "Botanist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["economic-geologist", "Economic Geologist", "Science", ["curious", "analytical", "hands-on", "practical"], ["Field mapping", "Data interpretation", "Geological analysis", "Report writing"]],
  ["environmental-geologist", "Environmental Geologist", "Science", ["curious", "analytical", "hands-on", "practical"], ["Field mapping", "Data interpretation", "Geological analysis", "Report writing"]],
  ["hydrogeologist", "Hydrogeologist", "Science", ["curious", "analytical", "hands-on", "practical"], ["Field mapping", "Data interpretation", "Geological analysis", "Report writing"]],
  ["geophysicist", "Geophysicist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["paleontologist", "Paleontologist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["climatologist", "Climatologist", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["oceanographer", "Oceanographer", "Science", ["curious", "analytical", "structured", "independent"], ["Research methods", "Lab techniques", "Data analysis", "Scientific writing"]],
  ["public-policy-advisor", "Public Policy Advisor", "Government", ["analytical", "communicator", "structured", "curious"], ["Policy research", "Stakeholder analysis", "Data interpretation", "Report writing"]],
  ["legislative-analyst", "Legislative Analyst", "Government", ["analytical", "communicator", "structured", "curious"], ["Policy research", "Stakeholder analysis", "Data interpretation", "Report writing"]],
  ["government-relations-advisor", "Government Relations Advisor", "Government", ["analytical", "communicator", "structured", "curious"], ["Policy research", "Stakeholder analysis", "Data interpretation", "Report writing"]],
  ["public-administration-consultant", "Public Administration Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["policy-researcher", "Policy Researcher", "Science", ["curious", "analytical", "structured", "independent"], ["Research design", "Data collection", "Analysis", "Scientific communication"]],
  ["program-evaluation-specialist", "Program Evaluation Specialist", "Government", ["analytical", "communicator", "structured", "curious"], ["Policy research", "Stakeholder analysis", "Data interpretation", "Report writing"]],
  ["public-sector-consultant", "Public Sector Consultant", "Business", ["analytical", "communicator", "structured", "curious"], ["Problem framing", "Client discovery", "Recommendations", "Presentation"]],
  ["economic-policy-analyst", "Economic Policy Analyst", "Government", ["analytical", "communicator", "structured", "curious"], ["Policy research", "Stakeholder analysis", "Data interpretation", "Report writing"]],
  ["social-policy-analyst", "Social Policy Analyst", "Government", ["analytical", "communicator", "structured", "curious"], ["Policy research", "Stakeholder analysis", "Data interpretation", "Report writing"]],
  ["health-policy-analyst", "Health Policy Analyst", "Government", ["analytical", "communicator", "structured", "curious"], ["Policy research", "Stakeholder analysis", "Data interpretation", "Report writing"]],
  ["education-policy-analyst", "Education Policy Analyst", "Government", ["analytical", "communicator", "structured", "curious"], ["Policy research", "Stakeholder analysis", "Data interpretation", "Report writing"]],
  ["environmental-policy-analyst", "Environmental Policy Analyst", "Government", ["analytical", "communicator", "structured", "curious"], ["Policy research", "Stakeholder analysis", "Data interpretation", "Report writing"]],
  ["economic-analyst", "Economic Analyst", "Government", ["analytical", "communicator", "structured", "curious"], ["Policy research", "Stakeholder analysis", "Data interpretation", "Report writing"]],
  ["labour-market-analyst", "Labour Market Analyst", "Government", ["analytical", "communicator", "structured", "curious"], ["Policy research", "Stakeholder analysis", "Data interpretation", "Report writing"]],
  ["statistical-consultant", "Statistical Consultant", "Science", ["analytical", "structured", "curious", "independent"], ["Statistical modeling", "Data analysis", "Study design", "Communication"]],
